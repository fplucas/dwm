...
static const char col_brown[]       = "#5C4033";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
    [SchemeNorm]	= { white,	black,	black },
    [SchemeInv]	= { black,  white,	black },
	[SchemeSel]	= { black,	blue,	magenta },
};
...
static const Rule rules[] = {
	...
	{ "Picture in Picture",  NULL,       "Picture in Picture", 0,        0,           -1 },
};
...
/*	{ 0,                            XK_Print,       	       spawn,          {.v = scrnsht} },
	{ ShiftMask                     XK_Print,     	           spawn,          {.v = sscrnsht} },*/
